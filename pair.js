...
async function uploadCredsToMega(credsPath) {
    try {
        const storage = await new Storage({
            email: 'peterhaiti2018@gmail.com', // Your Mega A/c Email Here
            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'Winshelphotography~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
💡 *Whats Next?* 
1️⃣ Explore all the cool features of winshelphotography.
2️⃣ Stay updated with our latest releases and support.
3️⃣ Enjoy seamless WhatsApp automation! 🤖  

🔗 *Join & Support :* 👉 [Click Here]wa.me/50933612915 

⭐ *Show Some Love!* Give us a ⭐ on Instagram and support the developer of: 👉 https://www.instagram.com/winshelphotography_official?igsh=MWtkYm1ocGJndG9iaw==  

📸 _Thanks for choosing WINSHELPHOTOGRAPHY — Let the automation begin!_ ✨`;
